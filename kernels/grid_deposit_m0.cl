  ...
  if (i_cell < *Nxm1Nrm1_4)
   {
    ...
    // allocate privite cell array for the deposition
    double scl_cell_m0[2][2] = {{0.,0.},{0.,0.}};
    scl_cell_m0[0][0] = scl_m0[i_grid_glob] ;
    scl_cell_m0[0][1] = scl_m0[i_grid_glob+1] ;
    scl_cell_m0[1][0] = scl_m0[i_grid_glob+Nx_grid] ;
    scl_cell_m0[1][1] = scl_m0[i_grid_glob+Nx_grid+1] ;
  ...
  if (i_cell < *Nxm1Nrm1_4)
   {
    ...
    vec_x_1_cell_m0[0][0] = vec_x_1_m0[i_grid_glob] ;
    vec_x_1_cell_m0[0][1] = vec_x_1_m0[i_grid_glob+1] ;
    vec_x_1_cell_m0[1][0] = vec_x_1_m0[i_grid_glob+Nx_grid] ;
    vec_x_1_cell_m0[1][1] = vec_x_1_m0[i_grid_glob+Nx_grid+1] ;

    vec_y_1_cell_m0[0][0] = vec_y_1_m0[i_grid_glob] ;
    vec_y_1_cell_m0[0][1] = vec_y_1_m0[i_grid_glob+1] ;
    vec_y_1_cell_m0[1][0] = vec_y_1_m0[i_grid_glob+Nx_grid] ;
    vec_y_1_cell_m0[1][1] = vec_y_1_m0[i_grid_glob+Nx_grid+1] ;

    vec_z_1_cell_m0[0][0] = vec_z_1_m0[i_grid_glob] ;
    vec_z_1_cell_m0[0][1] = vec_z_1_m0[i_grid_glob+1] ;
    vec_z_1_cell_m0[1][0] = vec_z_1_m0[i_grid_glob+Nx_grid] ;
    vec_z_1_cell_m0[1][1] = vec_z_1_m0[i_grid_glob+Nx_grid+1] ;

    vec_x_2_cell_m0[0][0] = vec_x_2_m0[i_grid_glob] ;
    vec_x_2_cell_m0[0][1] = vec_x_2_m0[i_grid_glob+1] ;
    vec_x_2_cell_m0[1][0] = vec_x_2_m0[i_grid_glob+Nx_grid] ;
    vec_x_2_cell_m0[1][1] = vec_x_2_m0[i_grid_glob+Nx_grid+1] ;

    vec_y_2_cell_m0[0][0] = vec_y_2_m0[i_grid_glob] ;
    vec_y_2_cell_m0[0][1] = vec_y_2_m0[i_grid_glob+1] ;
    vec_y_2_cell_m0[1][0] = vec_y_2_m0[i_grid_glob+Nx_grid] ;
    vec_y_2_cell_m0[1][1] = vec_y_2_m0[i_grid_glob+Nx_grid+1] ;

    vec_z_2_cell_m0[0][0] = vec_z_2_m0[i_grid_glob] ;
    vec_z_2_cell_m0[0][1] = vec_z_2_m0[i_grid_glob+1] ;
    vec_z_2_cell_m0[1][0] = vec_z_2_m0[i_grid_glob+Nx_grid] ;
    vec_z_2_cell_m0[1][1] = vec_z_2_m0[i_grid_glob+Nx_grid+1] ;
